sprint_editor.registerBlock('my_main_section3', function ($, $el, data, settings, currentEditorParams) {
    ...
    var blocklist = [
        {id: 'my_main_section3_1', title: 'Текста блока'},
        {id: 'my_main_section_3_2', title: 'Списки'},
        {id: 'my_main_section_3_3', title: 'Блок с видео'},
    ];
