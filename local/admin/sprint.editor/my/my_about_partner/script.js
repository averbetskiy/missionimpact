sprint_editor.registerBlock('my_about_partner', function ($, $el, data, settings) {
    ...
    var sendrequest = function (requestParams, callback) {
        ...
        $.ajax({
            url: sprint_editor.getBlockWebPath('my_hero_partner') + '/ajax.php',
            type: 'post',
            data: requestParams,
            dataType: 'json',
            success: function (result) {
                ...
                $jresult.html(
                    sprint_editor.renderTemplate('my_hero_partner-select', result)
                );
