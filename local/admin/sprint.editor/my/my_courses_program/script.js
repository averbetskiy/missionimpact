sprint_editor.registerBlock('my_courses_program', function ($, $el, data, settings, currentEditorParams) {
    ...
    var blocklist = [
        {id: 'my_project_text_program', title: 'Текста блока'},
        {id: 'my_project_item_program', title: 'Программа'},
    ];
