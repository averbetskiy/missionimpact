sprint_editor.registerBlock('my_main_hero', function ($, $el, data, settings, currentEditorParams) {
    ...
    var blocklist = [
        {id: 'my_main_hero_text', title: 'Текста блока'},
        {id: 'my_main_hero_list', title: 'Список'},
    ];
