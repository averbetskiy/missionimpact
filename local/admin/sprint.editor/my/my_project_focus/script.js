sprint_editor.registerBlock('my_project_focus', function ($, $el, data, settings, currentEditorParams) {
    ...
    var blocklist = [
        {id: 'my_project_focus_text', title: 'Текста'},
        {id: 'my_project_focus_item', title: 'Блок'},
    ];
