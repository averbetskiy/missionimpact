sprint_editor.registerBlock('my_project_statistic_new', function ($, $el, data, settings, currentEditorParams) {
    ...
    var blocklist = [
        {id: 'my_about_text_statistic', title: 'Текста блока'},
        {id: 'my_about_item_statistic', title: 'Статистика'},
    ];
