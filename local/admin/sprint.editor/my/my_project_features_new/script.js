sprint_editor.registerBlock('my_project_features_new', function ($, $el, data, settings, currentEditorParams) {
    ...
    var blocklist = [
        {id: 'my_project_features_text', title: 'Текста блока'},
        {id: 'my_poject_features_item', title: 'Преимущества'},
    ];
