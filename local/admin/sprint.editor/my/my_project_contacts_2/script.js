sprint_editor.registerBlock('my_project_contacts_2', function ($, $el, data, settings, currentEditorParams) {
    ...
    var blocklist = [
        {id: 'my_project_contacts_link', title: 'Ссылка'},
        {id: 'my_project_contacts_map', title: 'Текста и карта'},
    ];
