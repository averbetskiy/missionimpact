sprint_editor.registerBlock('my_courses_about', function ($, $el, data, settings, currentEditorParams) {
    ...
    var blocklist = [
        {id: 'text', title: 'Текст блока'},
        {id: 'my_courses_about_list', title: 'Список'},
    ];
