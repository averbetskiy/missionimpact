                ...
                if($arParams['REDIRECT']) {
                    if (Loader::includeModule("highloadblock")) {
                        ...
                        $rsData = $entity_data_class::getList(array(
                            "select" => ['*'],
                            "filter" => [
                                'UF_CODE' => ['PROFILE_NOTIFICATION_PROF_NAME', 'PROFILE_NOTIFICATION_PROF_DESC']
                            ]
                        ));
                        ...
                        $notificationsParams = [
                            ...
                            'UF_LINK' => '/personal/profile/',
                            'UF_USERS' => [$arResult["USER"]["ID"]],
                            'UF_NAME' => $resultTextNotification['PROFILE_NOTIFICATION_PROF_NAME']['UF_TEXT_EN'],
                            'UF_NAME_RU' => $resultTextNotification['PROFILE_NOTIFICATION_PROF_NAME']['UF_TEXT_RU'],
                            'UF_PREVIEW' => $resultTextNotification['PROFILE_NOTIFICATION_PROF_DESC']['UF_TEXT_EN'],
                            'UF_PREVIEW_RU' => $resultTextNotification['PROFILE_NOTIFICATION_PROF_DESC']['UF_TEXT_RU'],
                            'UF_TYPE' => 'Profile',
                            'UF_TYPE_RU' => 'Профиль'
                        ];
