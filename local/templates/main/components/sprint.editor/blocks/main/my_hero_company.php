...
$arFilterPartners = ['IBLOCK_ID' => $block['logos']['iblock_id'],'ID' => $block['logos']['element_ids']];
$resPartners = CIblockElement::GetList(["ID" => $block['logos']['element_ids']], $arFilterPartners, false, [], $arSelectPartners);
