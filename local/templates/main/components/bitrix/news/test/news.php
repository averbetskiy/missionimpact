...
<main class="diveinblog">
    ...
    <div class="container">
        <div class="diveinblog__intro">
            <?if($arHandBook['TEST_HTAG']['UF_VALUE']){?>
                <h3 class="index__heading __multiply"><?=$arHandBook['TEST_HTAG']['UF_VALUE']?></h3>
            <?}?>
            <div class="diveinblog__title"><?=$arHandBook['TEST']['UF_VALUE']?></div>
        </div>
