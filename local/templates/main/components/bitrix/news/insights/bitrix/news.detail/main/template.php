...
<div class="container">
    <div class="diveininner__wrap">
        <a href="/insights/" class="divein__back hoverMe" data-attr="<?=$arHandBook['BACK_TO_INSIGHTS']['UF_VALUE']?>"><?=$arHandBook['BACK_TO_INSIGHTS']['UF_VALUE']?></a>
        <div class="diveininner__content">
            <div class="divein__article">
                <div class="divein__meta">
                    <div class="divein__meta-type orange" data-type="article"><?=($arResult['PROPERTIES']['number']['VALUE'])?'№'.$arResult['PROPERTIES']['number']['VALUE']:""?></div>
