...
<!--    <div class="pageCourse__modulecard-number"></div>-->
    ...
    <?}?>
    <div class="pageCourse__modulecard-title"><?=$arHandBook['MODULE_TITLE']['UF_VALUE']?> <?=$arResult['PROPERTIES']['NUMBER']['VALUE']?></div>
