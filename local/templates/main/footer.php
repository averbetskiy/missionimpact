...
foreach($arHandBook['TITLE'] as $item){
    if($item['UF_CODE'] == 'TITLE' && $item['UF_LINK'] == $dir){
        $arTitle = $item;
    }
}
if($arTitle['UF_VALUE']) {
    $APPLICATION->SetTitle($arTitle['UF_VALUE']);
}
?>
<footer class="footer">
    <div class="container">
            ...
            if($lang == 's2'){
                $codeForm = 'subscribers_ru';
            }else{
                $codeForm = 'subscribers';
            }
            $arForm = CForm::GetBySID($codeForm)->Fetch();
            if($arForm){
            ?>
                <div class="footer__subscribe">
                    <div class="footer__subscribe-title"><?=$arHandBook['FOOTER_SUBSCRIBE_TITLE']['UF_VALUE']?></div>
                    <div class="footer__subscribe-text"><?=$arHandBook['FOOTER_SUBSCRIBE_TEXT']['UF_VALUE']?></div>
                    <?=$arForm['FORM_TEMPLATE']?>
                    <div class="footer__subscribe-text subscribe_success" style="display: none">
                        <?=$arHandBook['UF_SUBSCRIBE_SUCCESS']['UF_VALUE']?>
                    </div>
                    <div class="footer__subscribe-text subscribe_error" style="display: none;color:red;"></div>
                </div>
			<?}?>
        <div class="footer__top">
            ...
            <div class="footer__top-right">
                ...
                <?$APPLICATION->ShowViewContent('footer_menu_contact');?>
            </div>
        ...
        <div class="footer__bottom">
            <div class="footer__left">
                <div class="footer__copy">
                    © <?=date('Y')?><br>
                    <?=$arHandBook['BOTTOM_TEXT']['UF_VALUE']?>
                </div>
            </div>
            <div class="footer__center">
...
if($_COOKIE['mi_lets'] != 'Y') {
    $APPLICATION->IncludeComponent(
        ...
        array(
            "AJAX_MODE" => "N",
            "SEF_MODE" => "N",
            "WEB_FORM_ID" => ($_COOKIE['mi_lang'] == 's2')?'2':'1',
...
<div class="policy container">
	<div class="policy__wrap">
		<div class="policy__content">
			<div class="policy__title"><?=$arHandBook['POLICY_TITLE']['UF_VALUE']?></div>
			<div class="policy__text">
				<?=$arHandBook['POLICY_TEXT']['UF_VALUE']?>
			</div>
		</div>
		<a href="#" class="policy__button hoverMe" data-attr="<?=$arHandBook['POLICY_BUTTON']['UF_VALUE']?>"><?=$arHandBook['POLICY_BUTTON']['UF_VALUE']?></a>
	</div>
</div>

<script src="/local/assets/js/jquery.js"></script>
<script src="/local/assets/js/jquery-ui.js"></script>
<script src="/local/assets/js/gsap.js"></script>
<script src="/local/assets/js/scrollTrigger.js"></script>
<script src="/local/assets/js/cssRule.js"></script>
<script src="/local/assets/js/scrollSmooth.js"></script>
<script src="/local/assets/js/fancybox.js"></script>
<script src="/local/assets/js/obServer.js"></script>
<script src="/local/assets/js/drag.js"></script>
<script src="/local/assets/js/validate.min.js"></script>
<script src="/local/assets/js/inputmask.bundle.min.js"></script>
<script src="/local/assets/js/mask.js"></script>
<script src="/local/assets/js/intlTelInput-jquery.min.js"></script>
<script src="/local/assets/js/utils.min.js"></script>
<script src="/local/assets/js/swiper.js"></script>
<script src="/local/assets/js/air.js"></script>
<!--<script src="/local/assets/js/phonecode.js"></script>-->
<script src="/local/assets/js/main.js?1487583138267920"></script>
<script src="/local/assets/js/custom.js?1487583138267920"></script>

<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-6DTJ4QHV1F"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-6DTJ4QHV1F');
</script>

<!-- Top.Mail.Ru counter -->
<script type="text/javascript">
var _tmr = window._tmr || (window._tmr = []);
_tmr.push({id: "3322147", type: "pageView", start: (new Date()).getTime()});
(function (d, w, id) {
...
<noscript><div><img src="https://top-fwz1.mail.ru/counter?id=3322147;js=na" style="position:absolute;left:-9999px;" alt="Top.Mail.Ru" /></div></noscript>
<!-- /Top.Mail.Ru counter -->
...
<noscript><div><img src="https://mc.yandex.ru/watch/93201055" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
<!-- Yandex.Metrika counter -->
<script type="text/javascript" >
   (function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)};
...
<noscript><div><img src="https://mc.yandex.ru/watch/93268630" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
