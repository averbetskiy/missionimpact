	...
	<div class="container">
		...
		<div class="profile__inner">
			<nav class="profile__menu">
				<a href="/profile/projects.php" class="hoverMe active" data-attr="Projects">Projects</a>
				<a href="/profile/courses.php" class="hoverMe" data-attr="Courses">Courses</a>
			...
			<div class="profile__main">
				...
				<div class="profile__main-center">
					<div class="profile__projects-header">
						<div class="profile__projects-title"><p>Taking Steps Towards a Better Future</p></div>
						<div class="profile__projects-text"><p>Driven by a firm belief in the power of sharing insights, empowering talents, co-creating change and supporting diverse communities, these efforts strive towards a safer, more equal and better world.</p></div>
					</div>
					<div class="profile__projects-list">
<!--
						<a href="#project1" class="profile__projects-item">
							<div class="profile__projects-item__photo">
								<img src="/upload/iblock/68d/2agf330vhsjpzzdq0cr6kxw0s49k2xbx.jpg" alt="">
							</div>
							<div class="profile__projects-item__content">
								<div class="profile__projects-item__cat">For Youth</div>
								<div class="profile__projects-item__title">Impact Team 2050</div>
							</div>
						</a>
-->
						
<!--
						<div class="profile__popup" id="project1">
							...
							<div class="profile__popup-inner">
								...
								<div class="profile__popup-wrap">
									<div class="profile__popup-projects__title">ESG Learning</div>
									<div class="profile__popup-projects__text">On the way to creating a sustainable mindset among our employees, we offer programs that equip human capital with the ESG methodology and skills on three levels: strategic, managerial, and operational</div>
									<a href="#" class="profile__popup-projects__more hoverMe" data-attr="Explore →">Explore →</a>
									
									 Если он не зареган - выводим форму, если зареган - div с классом profile__popup-projects__exist 
									<?php $register = true; ?>
									
									<?php if (!$register): ?>
										<form action="" method="POST" class="profile__popup-projects__form">
											<div class="profile__popup-projects__form-title">I want to become a member</div>
											<div class="profile__popup-projects__form-text">Together we can create innovative and effective solutions to make this world a safer, fairer and better place</div>
											<div class="profile__popup-projects__form-group">
												<label for="name">Name</label>
												<input type="text" name="name" placeholder="Ekaterina Gert" required>
											</div>
											<div class="profile__popup-projects__form-group">
												<label for="email">E-mail</label>
												<input type="email" name="email" placeholder="gert@mail.com" required>
											</div>
											<button class="profile__popup-projects__form-button">Join</button>
										</form>
									<?php else: ?>
										<div class="profile__popup-projects__exist">
											<div class="profile__popup-projects__exist-title">I’m a member of the project</div>
											<div class="profile__popup-projects__exist-text">Together we can create innovative and effective solutions to make this world a safer, fairer and better place</div>
										</div>
									<?php endif; ?>
								</div>
							</div>
						</div>
						<a href="#" class="profile__projects-item">
							<div class="profile__projects-item__photo">
								<img src="/upload/iblock/68d/2agf330vhsjpzzdq0cr6kxw0s49k2xbx.jpg" alt="">
								<div class="profile__projects-item__member">member</div>
							</div>
							<div class="profile__projects-item__content">
								<div class="profile__projects-item__cat">For Youth</div>
								<div class="profile__projects-item__title">Impact Team 2050</div>
								...
								<div class="profile__projects-item__content">
									<div class="profile__projects-item__top">
										<?php if ($register): ?>
											<div class="profile__projects-item__member">Member</div>
										<?php endif; ?>
										<div class="profile__projects-item__tag">For Youth</div>
									</div>
									<div class="profile__projects-item__title">Impact Team 2050</div>
									<div class="profile__projects-item__text">Building a sustainable future with the younger generation</div>
								</div>
								<div class="profile__projects-item__link">
									<div class="hoverMe" data-attr="Explore →">Explore →</div>
								</div>
							</div>
						</a>
						<div class="profile__popup" id="project1">
							...
							<div class="profile__popup-inner">
								...
								<div class="profile__popup-wrap profile__popup-project">
									<div class="profile__popup-project__title profile__popup-title"><p>ESG Learning</p></div>
									<div class="profile__popup-project__text"><p>On the way to creating a sustainable mindset among our employees, we offer programs that equip human capital with the ESG methodology and skills on three levels: strategic, managerial, and operational</p></div>
									<a href="#" class="profile__popup-projects__more hoverMe" data-attr="Explore →">Explore →</a>
									
<!--								Если он не зареган - выводим форму, если зареган - div с классом profile__popup-projects__exist -->
									
									<?php if (!$register): ?>
										<form action="" method="POST" class="profile__popup-project__form">
											<div class="profile__popup-project__form-title">I want to become a member</div>
											<div class="profile__popup-project__form-text">Together we can create innovative and effective solutions to make this world a safer, fairer and better place</div>
											...
											<button class="profile__popup-form__button hoverMe" data-attr="Join">Join</button>
										</form>
									<?php else: ?>
										<div class="profile__popup-project__exist">
											<div class="profile__popup-project__exist-title">I’m a member of the project</div>
											<div class="profile__popup-project__exist-text">Together we can create innovative and effective solutions to make this world a safer, fairer and better place</div>
										</div>
									<?php endif; ?>
								</div>
							</div>
						...
						<?php $register = true; ?>
						<a href="#project2" class="profile__projects-item openProfilePopup">
							<div class="profile__projects-item__photo">
								<img src="/upload/iblock/68d/2agf330vhsjpzzdq0cr6kxw0s49k2xbx.jpg" alt="" loading="lazy">
							</div>
							<div class="profile__projects-item__inner">
						...
						<div class="profile__popup" id="project2">
							<div class="profile__popup-overlay"></div>
							<div class="profile__popup-inner">
								<div class="profile__popup-close">x</div>
								<div class="profile__popup-wrap profile__popup-project">
									<div class="profile__popup-project__title profile__popup-title"><p>ESG Learning 2</p></div>
									<div class="profile__popup-project__text"><p>On the way to creating a sustainable mindset among our employees, we offer programs that equip human capital with the ESG methodology and skills on three levels: strategic, managerial, and operational</p></div>
									<a href="#" class="profile__popup-projects__more hoverMe" data-attr="Explore →">Explore →</a>
...
<!--								Если он не зареган - выводим форму, если зареган - div с классом profile__popup-projects__exist -->
									...
									<?php if (!$register): ?>
										<form action="" method="POST" class="profile__popup-project__form">
											...
											<button class="profile__popup-form__button">Join</button>
										</form>
									<?php else: ?>
										<div class="profile__popup-project__exist">
											<div class="profile__popup-project__exist-title">I’m a member of the project</div>
						...
						<a href="#" class="profile__projects-item __empty">
							<div class="profile__projects-item__inner">
								<div class="profile__projects-item__content">
									<div class="profile__projects-item__title">A large number of social projects and initiatives</div>
								</div>
								<div class="profile__projects-item__link">
									<div class="hoverMe" data-attr="Learn more →">Learn more →</div>
								</div>
							</div>
						</a>
					</div>
			...
			<div class="popup__notify-list">
				<a href="#" class="popup__notify-item" data-status="new">
					<div class="popup__notify-item__photo">
						<img src="/images/profile/cover.png" alt="" loading="lazy">
					</div>
