...
<!--				<a href="/profile/events.php" class="hoverMe active" data-attr="Events">Events</a>-->
			...
			<div class="profile__main">
				<div class="profile__main-left">
					<div class="profile__tabs-select">
						<div class="profile__tabs-select__item active">My events <span>3</span></div>
				...
				<div class="profile__main-center">
									...
									<div class="profile__event-card">
										<div class="profile__event-card__content">
											<div class="profile__event-card__info">
												<div class="profile__event-card__date">13 April 2023・12:00 (Moscow time)</div>
												<div class="profile__event-card__title">Human-Centric Transformation</div>
											</div>
											<div class="profile__event-card__tools">
												<div class="profile__event-card__explore">
													<a href="#event1" class="hoverMe openProfilePopup" data-attr="Explore →">Explore →</a>
												</div>
												<div class="profile__event-card__addcal">
													<a href="#" class="hoverMe" data-attr="Add to Calendar +">Add to Calendar +</a>
												</div>
											</div>
										</div>
										<div class="profile__event-card__photo">
											<img src="/images/profile/event.png" alt="">
											<div class="profile__event-card__photo-content">
												<div class="profile__event-card__photo-time">23 hours/ 56 minutes left</div>
												<div class="profile__event-card__photo-type">Online webinar</div>
											</div>
										</div>
									</div>
									<div class="profile__popup" id="event1">
										...
										<div class="profile__popup-inner">
											...
											<div class="profile__popup-wrap profile__popup-event">
												<div class="profile__popup-title">Human-Centric Transformation</div>
												<div class="profile__popup-text"><p>Session «Human-Centric Transformation of Organizational and Corporate Cultures» within the framework of the 24th Yasin International Scientific Conference</p></div>
												<div class="profile__popup-event__meta">
													<div class="profile__popup-event__meta-date">13 April 2023</div>
													<div class="profile__popup-event__meta-type">Online webinar</div>
													<div class="profile__popup-event__meta-time">12:00, Moscow time</div>
												</div>
												<div class="profile__popup-event__photo"><img src="/images/profile/event.png" alt=""></div>
												<div class="profile__popup-event__content">
													<p>A modern approach to corporate management must focus on human-centric relationships with employees and those who are somehow involved in the operations of a company. A human-centric organization is focused on respecting the interests of a person as an individual, a member of a team and society.</p>
													<p>How is the organizational and corporate culture built in different countries of the world? What are the similarities and differences?<br> Can we speak about global standards of corporate culture? What elements do you need to pay attention to.</p>
												</div>
												<div class="profile__popup-event__program">
													<div class="profile__popup-event__program-title">Program</div>
													<div class="profile__popup-event__program-list">
														<div class="profile__popup-event__program-item">
															<div class="profile__popup-event__program-item__type">Moderator</div>
															<div class="profile__popup-event__program-item__title">Lydia Lebedeva</div>
															<div class="profile__popup-event__program-item__text">Head of the Project «Index of Human-Centricity of Companies» of Rosatom Corporate Academy</div>
														</div>
														<div class="profile__popup-event__program-item">
															<div class="profile__popup-event__program-item__type">Moderator</div>
															<div class="profile__popup-event__program-item__title">Lydia Lebedeva</div>
												...
												<a href="#" class="profile__popup-event__addcal addCalEvent" data-attr="Add to Calendar +">Add to Calendar +</a>
											</div>
										</div>
									</div>
								...
								<div class="profile__event">
									<div class="profile__event-card">
										<div class="profile__event-card__content">
											...
											<div class="profile__event-card__tools">
												<div class="profile__event-card__explore">
													<a href="#event2" class="hoverMe openProfilePopup" data-attr="Explore →">Explore →</a>
												</div>
												<div class="profile__event-card__addcal">
													<a href="#" class="hoverMe" data-attr="Add to Calendar +">Add to Calendar +</a>
												</div>
									...
									<div class="profile__popup" id="event2">
										<div class="profile__popup-overlay"></div>
										<div class="profile__popup-inner">
											<div class="profile__popup-close">x</div>
											<div class="profile__popup-wrap profile__popup-event">
												...
												<a href="#" class="profile__popup-event__addcal addCalEvent hoverMe" data-attr="Add to Calendar +">Add to Calendar +</a>
											</div>
										</div>
									</div>
								</div>
								<div class="profile__event">
									<div class="profile__event-card">
										<div class="profile__event-card__content">
											...
											<div class="profile__event-card__tools">
												<div class="profile__event-card__explore">
													<a href="#event3" class="hoverMe openProfilePopup" data-attr="Explore →">Explore →</a>
												</div>
												<div class="profile__event-card__addcal">
													<a href="#" class="hoverMe" data-attr="Add to Calendar +">Add to Calendar +</a>
												</div>
									...
									<div class="profile__popup" id="event3">
										<div class="profile__popup-overlay"></div>
										<div class="profile__popup-inner">
											<div class="profile__popup-close">x</div>
											<div class="profile__popup-wrap profile__popup-event">
								...
								<div class="profile__event">
									<div class="profile__event-card">
										<div class="profile__event-card__content">
											...
											<div class="profile__event-card__tools">
												<div class="profile__event-card__explore">
													<a href="#event4" class="hoverMe openProfilePopup" data-attr="Explore →">Explore →</a>
												</div>
												<div class="profile__event-card__addcal">
													<a href="#" class="hoverMe" data-attr="Add to Calendar +">Add to Calendar +</a>
												</div>
									...
									<div class="profile__popup" id="event4">
										<div class="profile__popup-overlay"></div>
										<div class="profile__popup-inner">
											<div class="profile__popup-close">x</div>
											<div class="profile__popup-wrap profile__popup-event">
							...
							<div class="profile__events-list">
								<div class="profile__event">
									<div class="profile__event-card">
										<div class="profile__event-card__content">
											<div class="profile__event-card__info">
												<div class="profile__event-card__date">13 April 2023</div>
												<div class="profile__event-card__title">Human-Centric Transformation</div>
											</div>
											<div class="profile__event-card__tools">
												<div class="profile__event-card__explore">
													<a href="#" class="hoverMe" data-attr="Explore →">Explore →</a>
												</div>
											</div>
										</div>
										<div class="profile__event-card__photo">
											<img src="/images/profile/event.png" alt="">
											<div class="profile__event-card__photo-content">
												<div class="profile__event-card__photo-time">Passed</div>
												<div class="profile__event-card__photo-type">Online webinar</div>
											</div>
										</div>
									</div>
					...
					<div class="profile__events-other">
						<div class="profile__events-other__title">Other events</div>
						<div class="profile__events-other__list">
							<div class="profile__events-other__item">
								<div class="profile__events-other__item-photo">
									<img src="/images/profile/event.png" alt="">
									<div class="profile__events-other__item-photo__type">Hybrid format</div>
								</div>
								<div class="profile__events-other__item-content">
									<div class="profile__events-other__item-top">
										<div class="profile__events-other__item-date">27 April 2023</div>
										<div class="profile__events-other__item-title">Ecosoc Youth Forum</div>
										<div class="profile__events-other__item-text">Side event at the 2023 Economic and Social Council Youth Forum</div>
									</div>
									<div class="profile__events-other__item-more">
										<a href="#" class="hoverMe" data-attr="Explore →">Explore →</a>
									</div>
								</div>
							</div>
				...
				<div class="profile__main-right">
					<div class="profile__events-times">
						<div class="profile__events-times__top">
							<div class="profile__events-times__time">23:56</div>
							<div class="profile__events-times__next">to the next event</div>
						</div>
						<div class="profile__events-times__bottom">
							<div class="profile__events-times__title">Human-Centric Transformation</div>
							<div class="profile__events-times__dates">13 April 2023・12:00 (Moscow time)</div>
						</div>
					</div>
				</div>
			</div>
